...
After carefully comparing names in each file, it was time to clean the names so they could be merged more easily.
...
The shiny app can be found [here](https://davebloom11.shinyapps.io/pssa_shiny_app/). All feedback is welcome!