...
tags:
  ...
  - R
  - crime
featured: thomas-young-634092-unsplash.jpg
...
strip_theme <- theme(strip.background = element_rect(fill = "white", color = "white"),
                     strip.text = element_text(color = "#54203F", size = rel(1.1)),
                     panel.border = element_rect(color = "#EDE5CF"),
                     plot.background = element_rect(color = "#EDE5CF")
                    )
...
```{r map_2001_2012, echo=TRUE, fig.width=9, message=FALSE, warning=FALSE}
...
Crime has grown over time, particularly in northern India, and from there, it appears to bve growing in nearby states as well. Without population data, it's difficult to draw much more insight.
