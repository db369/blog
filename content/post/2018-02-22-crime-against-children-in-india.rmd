...
myt <- ttheme_default(
  ...
  core = list(fg_params=list(hjust = 0.5, x=0.5),
              bg_params=list(fill=c("#EAE0CE", "#C9B5AC"))),
  colhead = list(fg_params=list(col="white"),
                 bg_params=list(fill="#54213F"))
 )
...
median_plot + annotation_custom(tableGrob(median.table,rows=NULL, theme = myt), xmin=88, xmax=98, ymin=8, ymax=18) + coord_cartesian()
